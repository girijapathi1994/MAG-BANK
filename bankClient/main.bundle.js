...
// module
exports.push([module.i, ".dashboardChart{\r\n    height:500px;\r\n    background-color: #74AFAD;\r\n}", ""]);
...
module.exports = "<h2 class=\"page-header\">Dashboard</h2>\n<p>Welcome to your dashboard</p>\n<div class=\"row\">\n    <div class=\"col-sm-12\">\n        <div #chart class=\"dashboardChart\">\n        </div>\n    </div>\n    \n</div>\n<div class=\"text-center text text-success\">\n    <h2>Information about your savings </h2>\n</div>\n\n\n"
...
var DashboardComponent = (function () {
    ...
    DashboardComponent.prototype.basicChart = function () {
...
module.exports = "<div class=\"jumbotron text-center\">\n  <h1>MAG BANK</h1>\n  <p class=\"lead\">The one and only one bank where your thoughts are stored and returned with interest. </p>\n  <div *ngIf=\"!authService.loggedIn()\">\n    <a class=\"btn btn-info\" [routerLink]=\"['/register']\">Register</a> <a class=\"btn btn-success\" [routerLink]=\"['/login']\">Login</a>\n  </div>\n</div>\n\n<div class=\"row\">\n  <div class=\"col-md-4\">\n    <h3>Magnificent</h3>\n    <p>You finds it is extremely beautiful, talented, impressive and how many synonyms applicable for M </p>\n  </div>\n  <div class=\"col-md-4\">\n    <h3>Attractive</h3>\n    <p>To describe A ....simply clone of Magnet where each and every one becomes iron.</p>\n  </div>\n    \n  <div class=\"col-md-4\">\n    <h3>Gullible</h3>\n    <p>One of the waste word exists, which always thinks about M, A and always think only about M, A. </p>\n  </div>\n</div>\n"
...
module.exports = "<nav class=\"navbar navbar-inverse\">\n  <div class=\"container-fluid\">\n    <div class=\"navbar-header\">\n      <a class=\"navbar-brand\" href=\"#\">{{title}}</a>\n    </div>\n    <ul class=\"nav navbar-nav\">\n      <li [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a [routerLink]=\"['/']\">Home</a></li>\n    </ul>\n    <ul class=\"nav navbar-nav navbar-right\">\n        <li *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a [routerLink]=\"['/dashboard']\"><span class=\"glyphicon glyphicon-move\"></span>Dashboard</a></li>\n        <li *ngIf=\"authService.loggedIn()\" [routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a [routerLink]=\"['/profile']\"><span class=\"glyphicon glyphicon-tree-deciduous\"></span> Profile</a></li>\n      <li *ngIf=\"!authService.loggedIn()\"[routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a [routerLink]=\"['/register']\"><span class=\"glyphicon glyphicon-user\"></span>Register</a></li>\n      <li *ngIf=\"!authService.loggedIn()\"[routerLinkActive]=\"['active']\" [routerLinkActiveOptions]=\"{exact:true}\"><a [routerLink]=\"['/login']\"><span class=\"glyphicon glyphicon-log-in\"></span> Login</a></li>\n      <li *ngIf=\"authService.loggedIn()\"><a (click)=\"onLogOutClick()\" href=\"#\"><span class=\"glyphicon glyphicon-log-out\"></span> LogOut</a></li>\n    </ul>\n  </div>\n</nav>"
